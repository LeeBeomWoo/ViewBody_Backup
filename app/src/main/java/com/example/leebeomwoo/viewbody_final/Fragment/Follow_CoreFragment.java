...
public class Follow_CoreFragment extends android.support.v4.app.Fragment implements SearchView.OnQueryTextListener {
    ...
    private void listStart(){
        ...
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_Follow_Core();
    ...
    public static Follow_CoreFragment newInstance() {
        return new Follow_CoreFragment();
    }
}
