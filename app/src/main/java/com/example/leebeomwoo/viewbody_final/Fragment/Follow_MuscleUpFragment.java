...
public class Follow_MuscleUpFragment extends android.support.v4.app.Fragment implements SearchView.OnQueryTextListener {
    ...
    public Follow_MuscleUpFragment(){}
    ...
    private void listStart(){
        ...
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_Follow_MuscleUp();
    ...
    public static Follow_MuscleUpFragment newInstance() {
        return new Follow_MuscleUpFragment();
    }
}
