...
public class Follow_BrethFragment extends android.support.v4.app.Fragment implements SearchView.OnQueryTextListener {
    ...
    private void listStart(){
        ...
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_breth();
