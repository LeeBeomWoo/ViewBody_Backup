...
public class Follow_MuscleUpFragment extends android.support.v4.app.Fragment {
    ...
    String TAG = "Follow_MuscleUpFragment";
    ...
    private void listStart(){
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_List("Follow_MuscleUp");
