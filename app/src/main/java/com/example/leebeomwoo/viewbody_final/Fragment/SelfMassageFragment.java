...
public class SelfMassageFragment extends android.support.v4.app.Fragment implements SearchView.OnQueryTextListener {
    ...
    private void listStart(){
        ...
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_SelfMassage();
