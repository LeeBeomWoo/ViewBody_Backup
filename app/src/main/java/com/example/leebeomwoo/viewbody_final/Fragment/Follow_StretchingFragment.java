...
public class Follow_StretchingFragment extends android.support.v4.app.Fragment implements SearchView.OnQueryTextListener {
    ...
    public Follow_StretchingFragment(){}
    ...
    private void listStart(){
        ...
        Call<ResponseLd> call = ConAdapter.getInstance().getResult_Follow_Stretching();
    ...
    public static Follow_StretchingFragment newInstance() {
        return new Follow_StretchingFragment();
    }
}
